...
// src/user-preferences-actor/index.ts
import { Actor } from "./runtime.js";
var UserPreferencesActor = class extends Actor {
  ...
  async initialize() {
    ...
    if (!existing) {
      await this.state.storage.put("state", { preferences: {}, updatedAt: (/* @__PURE__ */ new Date()).toISOString() });
    }
  }
  async updatePreferences(prefs) {
    try {
      await this.state.storage.put("state", { preferences: prefs, updatedAt: (/* @__PURE__ */ new Date()).toISOString() });
...
var user_preferences_actor_default = UserPreferencesActor;

// <stdin>
var stdin_default = user_preferences_actor_default;
export {

...
// src/gemini-rag-agent/index.ts
var implementation = {
  name: "gemini-rag-agent",
  version: "1.0.0"
};
var gemini_rag_agent_default = (server, env, state) => {
  server.registerTool(
    "add",
    {
      title: "Addition Tool",
...
// <stdin>
var stdin_default = gemini_rag_agent_default;
export {
  cors,
